...
```
## Firmware Drivers:
Firmware drivers for EF_GPIO8 can be found in the [EF_GPIO8](https://github.com/efabless/EFIS/tree/main/EF_GPIO8) directory in the [EFIS](https://github.com/efabless/EFIS) repo. EF_GPIO8 driver documentation  is available [here](https://github.com/efabless/EFIS/tree/main/EF_GPIO8/README.md).
You can also find an example C application using the EF_GPIO8 drivers [here](https://github.com/efabless/EFIS/tree/main/EF_GPIO8/EF_GPIO8_example.c).
## Installation:
